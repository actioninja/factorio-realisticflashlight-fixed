...
local character_picture =
  {
    filename = "__realistic-flashlight-fixed__/graphics/lightcone_enhanced.png",
    priority = "extra-high",
    flags = {"light"},
    scale = 2,
    width = 350,
...
local vehicle_picture =
  {
    filename = "__realistic-flashlight-fixed__/graphics/lightcone_enhanced-vehicle.png",
    priority = "extra-high",
    flags = {"light"},
    scale = 2,
    width = 350,
